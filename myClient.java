...
public class myClient {
    ...
    public myClient(String host, int tcpPort, int udpPort, boolean isTCP) throws IOException {
        this.host = host;
    ...
    public static void sendMsgUDP(String st, myClient client) throws IOException {
    ...
    public static String readMsgUDP(myClient client){
    ...
    public static void sendMsg(String st, myClient client) throws IOException {
        if(client.isTCP){
    ...
    public static String readMsg(myClient client) throws IOException {
        if(client.isTCP){
    ...
    public static void main(String args[]) throws IOException {
        ...
        //start client
        myClient client = new myClient(hostAddress, tcpPort, udpPort, true);
        //
